...
//Passphrase and masterPassword
    String passPhrase = "Noe199710.121-232";
...
// Aes encrypt phrase
    String cipherPassPhrase = crypt.encrypt(passPhrase, masterPassword, "2��\"trh�)6�|R", "q40mTVuvoo1XpEGU");
     String cipherPassPhrase2 = crypt.decrypt(cipherPassPhrase, masterPassword, "2��\"trh�)6�|R", "q40mTVuvoo1XpEGU");

    System.out.println(cipherPassPhrase);
    System.out.println(cipherPassPhrase2 );
